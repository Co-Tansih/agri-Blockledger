      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 to-green-800 p-12 flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-green-100 text-lg mb-8 leading-relaxed">
            From farm to table, ensure transparency and trust in India's agricultural ecosystem with blockchain-powered traceability.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center text-green-100">
              ...
              <span>Farmer → Broker → MNC → Retailer → Customer</span>
            </div>
