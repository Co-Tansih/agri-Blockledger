...
-- Insert development test users (these will be created when the SQL runs)
-- Note: You'll need to manually create these users in Supabase Auth or use the signup process
